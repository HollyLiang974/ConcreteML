...
TestMul("int2ec",[(np.random.randint(-2, 1),np.random.randint(-2, 1)) for i in range(10000)], np.random.randint(-2, 1), np.random.randint(-2, 1), {"x": "encrypted", "y": "clear"})
TestMul("int2ee",[(np.random.randint(-2, 1),np.random.randint(-2, 1)) for i in range(10000)], np.random.randint(-2, 1), np.random.randint(-2, 1), {"x": "encrypted", "y": "encrypted"})
TestMul("int4ec",[(np.random.randint(-8, 7),np.random.randint(-8, 7)) for i in range(10000)], np.random.randint(-8, 7), np.random.randint(-8, 7), {"x": "encrypted", "y": "clear"})
TestMul("int4ee",[(np.random.randint(-8, 7),np.random.randint(-8, 7)) for i in range(10000)], np.random.randint(-8, 7), np.random.randint(-8, 7), {"x": "encrypted", "y": "encrypted"})
TestMul("int8ec",[(np.random.randint(-128, 127),np.random.randint(-128, 127)) for i in range(10000)], np.random.randint(-128, 127), np.random.randint(-128, 127), {"x": "encrypted", "y": "clear"})
TestMul("int8ee",[(np.random.randint(-128, 127),np.random.randint(-128, 127)) for i in range(10000)], np.random.randint(-128, 127), np.random.randint(-128, 127), {"x": "encrypted", "y": "encrypted"})
